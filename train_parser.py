...
# from single_pendulum import single_pendulum_dataset
...
def train(args):
    ...
    # trainData, valData, testData = single_pendulum_dataset(args.train_size, int(0.1 * args.train_size), args.test_size)
    # train_dataloader = DataLoader(trainData, batch_size=args.train_batch_size, shuffle=True)
    # test_dataloader = DataLoader(testData, batch_size=args.test_batch_size, shuffle=False)
    logger("data loaded.")
